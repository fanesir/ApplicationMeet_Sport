...
public class UserAccountInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.userInfoImageView);


        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                databaseReference = FirebaseDatabase.getInstance().getReference("user_Account_Data")
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Picasso.get().load(aboutAccountUsetDataset.getUserImage()).into(imageView);
                    }
